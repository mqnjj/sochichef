        ...
        <ul className={style['programs__card-list']}>
          <li className={style['programs__card-item']}>
            <div className={style['programs__card-item__main']}>
              ...
              <div
                className={clsx(
                  style['programs__card-item__main-description'],
                  'hidden-mobile',
                )}
              >
                <div
                  className={
                    style['programs__card-item__main-description__title']
                  }
                >
                  Что входит?
                </div>
                <div
                  className={
                    style['programs__card-item__main-description__main']
                  }
                >
                  <ul
                    className={
                      style['programs__card-item__main-description__main-list']
                    }
                  >
                    <li
                      className={
                        style[
                          'programs__card-item__main-description__main-item'
                        ]
                      }
                    >
              ...
              <CardList title={'Что входит?'}>
                ...
                >
                  <li
                    className={
                      style['programs__card-item__main-description__main-item']
                    }
                  >
                    Фундаментальные знания и навыки
                  </li>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      Концепции: &quot;Farm-to-Table&quot; (От фермы до стола),
          ...
          <li className={style['programs__card-item']}>
            <div className={style['programs__card-item__main']}>
              <h3 className={style['programs__card-item__main-title']}>
                ...
                <span
                  className={style['programs__card-item__main-title--span']}
                >
                  и взрослых
                </span>
              </h3>
